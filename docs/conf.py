# -*- coding: utf-8 -*-
#
# storj package documentation build configuration file.
#
...
#
html_theme_options = {
    u'description': u'A Python SDK for the Storj API.',
    u'fixed_sidebar': True,
    u'github_button': True,
    u'github_repo': u'storj-python-sdk',
    u'github_user': u'Storj',
